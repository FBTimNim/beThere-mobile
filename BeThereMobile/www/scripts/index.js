  ...
  var welcomescreen_slides = [
    {
      id : 'slide0',
      picture :
          '<img src="images/icon.png" alt="" class="circ" style="width: 230px"/>',
      text :
          '<h1 style="padding-bottom: 5vh">Welcome to beThere, the <b>premiere</b> festival media sharing app!</h1>'
    },
    {
      id : 'slide1',
      picture :
          '<img src="images/map01.png" alt="" class="circ" style="width: 230px"/>',
      text :
          "<h1 style='padding-bottom: 5vh'>Just drag around the map to view your Facebook friends' posts.</h1>"
    },
    {
      id : 'slide2',
      picture :
          '<img src="images/map01.png" alt="" class="circ" style="width: 230px"/>',
      text :
          '<h1 style="padding-bottom: 8.7vh">You can add your sick gig footage at any time!</h1>'
    },
    {
      id : 'slide3',
      picture :
          '<img src="images/map01.png" alt="" class="circ" style="width: 230px"/>',
      text :
          '<h1 style="padding-bottom: 0.5vh">Swipe right to see the ongoing Facebook events near you.*<br/><p style="font-size: 10px">*in the next product iteration, teehee</p></h1>'
    },
    {
      id : 'slide4',
      picture :
          '<img src="http://cdn.hercampus.com/s3fs-public/styles/full_width_embed/public/2015/04/12/persons-0041_large.png" alt="" class="circ" style="width: 220px; padding-top: 3vh" />',
      text :
          "<div class='close-welcomescreen' style='margin-bottom: 9.7vh'><h1 style='margin-bottom: 0px'>That's it! Happy festival!</h1><br />Tap to continue.</div>"
    }
  ];
  ...
  function onDeviceReady() {
    ...
    myApp.onPageInit('uploadphoto', function(page) {
      $$(page.container).find('#btnUploadCamera').on('click', function(e) {
        // launch device camera
        if (!(navigator && navigator.camera)) {
          myApp.addNotification({message : 'No Camera Access!'});
        } else {
          if (!window.FBLogin.loggedIn) {
            alert("You are not logged in!");
            return;
          ...
          navigator.camera.getPicture(
              function(data) {
                console.log(data);
                myApp.addNotification({message : 'PhotoURI:' + data});
                var fileURL = data;
                ...
                console.log(options);
                ft.upload(
                    fileURL, encodeURI(SERVER_URL + "/api/upload"),
                    function(r) {
                      console.log(r);
                      myApp.addNotification({message : 'Upload Succeeded'});
                      // exit page
                    },
                    function(error) {
                      console.log('upload error:', error);
              ...
              function(error) {
                myApp.addNotification({message : 'Error: ' + error});
              },
              {
      ...
      $$(page.container).find('#btnUploadCamera').on('click', function(e) {
        ...
        navigator.device.capture.captureVideo(
            function(files) {
              ...
              console.log(options);
              ft.upload(fileURL, encodeURI(SERVER_URL + "/api/upload"),
                        function(r) {
                          console.log(r);
                          myApp.addNotification({message : 'Upload Succeeded'});
                          // exit page
